...
`;var c2=Object.defineProperty,W1=(a,e,t,o)=>{for(var s=void 0,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=n(e,t,s)||s);return s&&c2(e,t,s),s};const pe=class pe extends f{constructor(){super(...arguments),this.for="",this.label="",this.description="",this.flag=""}render(){return l`
      <div class="nys-label">
    ...
    `}};pe.styles=l2;let u1=pe;W1([i({type:String})],u1.prototype,"for"),W1([i({type:String})],u1.prototype,"label"),W1([i({type:String})],u1.prototype,"description"),W1([i({type:String})],u1.prototype,"flag"),customElements.get("nys-label")||customElements.define("nys-label",u1);const Fe=v`
  :host {
