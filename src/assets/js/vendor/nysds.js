...
`;var Z1=Object.defineProperty,Fe=(a,e,t,o)=>{for(var s=void 0,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=n(e,t,s)||s);return s&&Z1(e,t,s),s};let U1=0;const gt=class gt extends p{constructor(){super(),this.id="",this.heading="",this.expanded=!1,this.bordered=!1}connectedCallback(){super.connectedCallback(),this.id||(this.id=this._generateUniqueId())}firstUpdated(){const e=this.shadowRoot?.querySelector("slot");this.expanded&&e&&e.addEventListener("slotchange",()=>{this._updateHeight()})}updated(e){e.has("expanded")&&this._updateHeight()}_generateUniqueId(){return`nys-accordionitem-${Date.now()}-${U1++}`}_dispatchEvent(){this.dispatchEvent(new CustomEvent("nys-accordionitem-toggle",{detail:{id:this.id,heading:this.heading,expanded:this.expanded},bubbles:!0,composed:!0}))}_handleExpand(){this.expanded=!this.expanded,this._updateHeight(),this._dispatchEvent()}_handleKeydown(e){(e.key===" "||e.key==="Enter")&&(e.preventDefault(),this._handleExpand())}_updateHeight(){if(this._contentContainer)if(this.expanded){const e=this._contentContainer.scrollHeight;this._contentContainer.style.height=`${e}px`}else this._contentContainer.style.height="0",this._contentContainer.style.overflow="hidden"}render(){const e=`${this.id}-content`;return l`
    ...
    >
      <slot></slot>
    </div>`}};bt.styles=Wt;let $e=bt;pt([i({type:String})],$e.prototype,"id"),pt([i({type:Boolean,reflect:!0})],$e.prototype,"singleSelect"),pt([i({type:Boolean,reflect:!0})],$e.prototype,"bordered"),customElements.get("nys-accordion")||customElements.define("nys-accordion",$e);const R1=g`
  :host {
    /* Global Alert Styles */
...
`;var W1=Object.defineProperty,Q=(a,e,t,o)=>{for(var s=void 0,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=n(e,t,s)||s);return s&&W1(e,t,s),s};let K1=0;const _t=class _t extends p{constructor(){super(...arguments),this.id="",this.ariaLabel="",this.image="",this.initials="",this.icon="",this.color="",this.interactive=!1,this.disabled=!1,this.lazy=!1,this._slotHasContent=!0}connectedCallback(){super.connectedCallback(),this.id||(this.id=`nys-avatar-${Date.now()}-${K1++}`)}firstUpdated(){this._checkSlotContent()}async _checkSlotContent(){const e=this.shadowRoot?.querySelector("slot");if(!e){this._slotHasContent=!1;return}await Promise.resolve();const t=e.assignedNodes({flatten:!0}).filter(o=>o.nodeType===Node.ELEMENT_NODE||o.nodeType===Node.TEXT_NODE&&o.textContent?.trim());this._slotHasContent=t.length>0}getContrastForeground(){const e="var(--nys-color-ink, #000)",t="var(--nys-color-ink-reverse, #fff)",o="var(--nys-color-text, #000)",s="var(--nys-color-text-reverse, #fff)";if(!this.color)return;const r=document.createElement("div");r.style.color=this.color,document.body.appendChild(r);const n=getComputedStyle(r).color;document.body.removeChild(r);const c=n.match(/\d+/g);if(!c)return;const d=Number(c[0]),h=Number(c[1]),f=Number(c[2]),w=(.299*d+.587*h+.114*f)/255<.5;return this.initials?.length>0?w?s:o:w?t:e}render(){return l`
    ...
    `}};_t.styles=G1;let O=_t;Q([i({type:String})],O.prototype,"id"),Q([i({type:String})],O.prototype,"ariaLabel"),Q([i({type:String})],O.prototype,"image"),Q([i({type:String})],O.prototype,"initials"),Q([i({type:String})],O.prototype,"icon"),Q([i({type:String})],O.prototype,"color"),Q([i({type:Boolean,reflect:!0})],O.prototype,"interactive"),Q([i({type:Boolean,reflect:!0})],O.prototype,"disabled"),Q([i({type:Boolean,reflect:!0})],O.prototype,"lazy"),Q([M()],O.prototype,"_slotHasContent"),customElements.get("nys-avatar")||customElements.define("nys-avatar",O);const Y1=g`
  .nys-backtotop {
...
`;var X1=Object.defineProperty,st=(a,e,t,o)=>{for(var s=void 0,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=n(e,t,s)||s);return s&&X1(e,t,s),s};const Ct=class Ct extends p{constructor(){super(),this.position="right",this.visible=!1,this.isMobile=!1,this.forceVisible=!1,this._handleScroll=this._handleScroll.bind(this),this._handleResize=this._handleResize.bind(this),this.mediaQuery=window.matchMedia("(max-width: 480px)")}connectedCallback(){super.connectedCallback(),this.forceVisible=this.hasAttribute("visible"),window.addEventListener("scroll",this._handleScroll),this.mediaQuery.addEventListener("change",this._handleResize),this._handleResize()}disconnectedCallback(){window.removeEventListener("scroll",this._handleScroll),this.mediaQuery.removeEventListener("change",this._handleResize),super.disconnectedCallback()}_handleScroll(){if(this.forceVisible)return;const e=window.innerHeight,t=document.documentElement.scrollHeight;this.visible=t>=e*4&&window.scrollY>e*1.5}_scrollToTop(){window.scrollTo({top:0,behavior:"smooth"})}_handleResize(){this.isMobile=this.mediaQuery.matches}render(){const e=["nys-backtotop",this.position,this.visible?"visible":""].filter(Boolean).join(" ");return l`<nys-button
    ...
    ></nys-button>`}};Ct.styles=Y1;let fe=Ct;st([i({type:String})],fe.prototype,"position"),st([i({type:Boolean,reflect:!0})],fe.prototype,"visible"),st([M()],fe.prototype,"isMobile"),st([M()],fe.prototype,"forceVisible"),customElements.get("nys-backtotop")||customElements.define("nys-backtotop",fe);const Q1=g`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;var Is=Object.defineProperty,Ps=Object.getOwnPropertyDescriptor,H=(a,e,t,o)=>{for(var s=o>1?void 0:o?Ps(e,t):e,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=(o?n(e,t,s):n(s))||s);return o&&s&&Is(e,t,s),s};let Os=0;const D=(de=class extends p{constructor(){super(),this.id="",this.name="",this.required=!1,this.optional=!1,this.showError=!1,this.errorMessage="",this.label="",this.description="",this.tile=!1,this._tooltip="",this.inverted=!1,this.form=null,this.selectedValue=null,this._slottedDescriptionText="",this._size="md",this._internals=this.attachInternals()}get size(){return this._size}set size(e){this._size=de.VALID_SIZES.includes(e)?e:"md"}connectedCallback(){super.connectedCallback(),this.id||(this.id=`nys-radiogroup-${Date.now()}-${Os++}`),this.addEventListener("nys-change",this._handleRadioButtonChange),this.addEventListener("invalid",this._handleInvalid)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("nys-change",this._handleRadioButtonChange),this.removeEventListener("invalid",this._handleInvalid)}async firstUpdated(){this._initializeCheckedRadioValue(),this._setValue(),this._setRadioButtonRequire(),this._updateRadioButtonsSize(),this._updateRadioButtonsTile(),this._updateRadioButtonsShowError(),this._getSlotDescriptionForAria(),await this.updateComplete,this._initializeChildAttributes(),this._updateGroupTabIndex()}updated(e){(e.has("required")||e.has("selectedValue"))&&this._manageRequire(),e.has("size")&&this._updateRadioButtonsSize(),e.has("tile")&&this._updateRadioButtonsTile(),e.has("inverted")&&this._updateRadioButtonsInvert(),e.has("showError")&&this._updateRadioButtonsShowError(),e.has("form")&&this._updateRadioButtonsForm()}formResetCallback(){this.querySelectorAll("nys-radiobutton").forEach(t=>{t.formResetUpdate()})}_setValue(){this._internals.setFormValue(this.selectedValue)}_setRadioButtonRequire(){this.querySelectorAll("nys-radiobutton").forEach((t,o)=>{this.required&&o===0&&t.setAttribute("required","required")})}async _manageRequire(){const e=this.errorMessage||"Please select an option.",o=Array.from(this.querySelectorAll("nys-radiobutton"))[0];o&&(this.required&&!this.selectedValue?this._internals.setValidity({valueMissing:!0},e,o):(this.showError=!1,this._internals.setValidity({},"",o)))}checkValidity(){const e=Array.from(this.querySelectorAll("nys-radiobutton"));return!this.required||e.some(o=>o.checked)}_initializeCheckedRadioValue(){const e=this.querySelector("nys-radiobutton[checked]");e&&(this.selectedValue=e.getAttribute("value"),this._internals.setFormValue(this.selectedValue))}_getAllRadios(){return Array.from(this.querySelectorAll("nys-radiobutton"))}async _handleKeyDown(e){if(!["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," ","Enter"].includes(e.key))return;e.preventDefault();const o=this._getAllRadios().filter(h=>!h.disabled),s=o.find(h=>h.checked)||o[0],r=e.key===" "||e.key==="Enter"?0:["ArrowUp","ArrowLeft"].includes(e.key)?-1:1;let n=o.indexOf(s)+r;n<0&&(n=o.length-1),n>=o.length&&(n=0);const c=o[n];(await c.getInputElement())?.click(),this._updateGroupTabIndex(),c.focus()}_updateGroupTabIndex(){const e=this._getAllRadios(),t=e.find(o=>o.checked)||e[0];e.forEach(o=>{o.disabled?o.tabIndex=-1:o.tabIndex=o===t?0:-1,o.setAttribute("aria-checked",o.checked?"true":"false"),o.setAttribute("aria-disabled",o.disabled?"true":"false"),o.setAttribute("aria-required",this.required?"true":"false")})}_initializeChildAttributes(){this._getAllRadios().forEach(t=>{t.setAttribute("role","radio"),t.setAttribute("aria-checked",String(t.checked)),t.setAttribute("aria-required",String(t.required)),t.setAttribute("aria-disabled",String(t.disabled)),t.setAttribute("tabindex","-1")})}_updateRadioButtonsSize(){this.querySelectorAll("nys-radiobutton").forEach(t=>{t.setAttribute("size",this.size)})}_updateRadioButtonsTile(){this.querySelectorAll("nys-radiobutton").forEach(t=>{this.tile?t.toggleAttribute("tile",!0):t.removeAttribute("tile")})}_updateRadioButtonsInvert(){this.querySelectorAll("nys-radiobutton").forEach(t=>{this.inverted?t.toggleAttribute("inverted",!0):t.removeAttribute("inverted")})}_updateRadioButtonsShowError(){this.querySelectorAll("nys-radiobutton").forEach(t=>{this.showError?t.setAttribute("showError",""):t.removeAttribute("showError")})}_updateRadioButtonsForm(){this.querySelectorAll("nys-radiobutton").forEach(t=>{this.showError&&this.form!==null?t.setAttribute("form",this.form):t.removeAttribute("form")})}_getSlotDescriptionForAria(){const t=this.shadowRoot?.querySelector('slot[name="description"]')?.assignedNodes({flatten:!0})||[];this._slottedDescriptionText=t.map(o=>o.textContent?.trim()).filter(Boolean).join(", ")}_handleRadioButtonChange(e){const t=e,{name:o,value:s}=t.detail;this.name=o,this.selectedValue=s,this._internals.setFormValue(this.selectedValue),this._updateGroupTabIndex()}async _handleInvalid(e){if(e.preventDefault(),this._internals.validity.valueMissing){this.showError=!0,this._manageRequire();const t=this.querySelector("nys-radiobutton");if(t){const o=this._internals.form;o?Array.from(o.elements).find(n=>typeof n.checkValidity=="function"&&!n.checkValidity())===this&&(t.focus(),t.classList.add("active-focus")):(t.focus(),t.classList.add("active-focus"))}}}render(){return l`<div class="nys-radiogroup">
    ...
    `}},m.VALID_SIZES=["sm","md"],m.buttonGroup={},m.styles=o1,m);N([i({type:Boolean,reflect:!0})],R.prototype,"checked",2),N([i({type:Boolean,reflect:!0})],R.prototype,"disabled",2),N([i({type:Boolean,reflect:!0})],R.prototype,"required",2),N([i({type:String})],R.prototype,"label",2),N([i({type:String})],R.prototype,"description",2),N([i({type:String})],R.prototype,"id",2),N([i({type:String,reflect:!0})],R.prototype,"name",2),N([i({type:String})],R.prototype,"value",2),N([i({type:Boolean,reflect:!0})],R.prototype,"inverted",2),N([i({type:String,reflect:!0})],R.prototype,"form",2),N([i({reflect:!0})],R.prototype,"size",1),N([i({type:Boolean,reflect:!0})],R.prototype,"tile",2);let n1=R;customElements.get("nys-radiobutton")||customElements.define("nys-radiobutton",n1);const Ts=g`
  :host {
...
`;var Rs=Object.defineProperty,We=(a,e,t,o)=>{for(var s=void 0,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=n(e,t,s)||s);return s&&Rs(e,t,s),s};class ne extends p{constructor(){super(...arguments),this.disabled=!1,this.selected=!1,this.value="",this.label="",this.hidden=!1}firstUpdated(){const e=this.shadowRoot?.querySelector("slot");e&&e.addEventListener("slotchange",()=>{const t=e.assignedNodes({flatten:!0});t.length>0&&(this.label=t[0].textContent?.trim()||"")})}render(){return l`
      <option
        ?disabled=${this.disabled}
...
`;var Ks=Object.defineProperty,Ae=(a,e,t,o)=>{for(var s=void 0,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=n(e,t,s)||s);return s&&Ks(e,t,s),s};const St=class St extends p{constructor(){super(...arguments),this.selected=!1,this.current=!1,this.label="",this.href="",this.isCompactExpanded=!1,this.stepNumber=0}_handleActivate(e){typeof this.onClick=="function"&&this.onClick(e);const t=new CustomEvent("nys-step-click",{bubbles:!0,composed:!0,cancelable:!0,detail:{href:this.href,label:this.label}});(this.hasAttribute("previous")||this.current)&&!this.selected&&(this.dispatchEvent(t),!t.defaultPrevented&&this.href&&(window.location.href=this.href))}_handleKeydown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._handleActivate(e))}render(){return l`
    ...
    `}};Lt.styles=l1;let ie=Lt;Ke([i({type:String})],ie.prototype,"id"),Ke([i({type:String,reflect:!0})],ie.prototype,"name"),Ke([i({type:String})],ie.prototype,"label"),Ke([i({type:String})],ie.prototype,"counterText"),Ke([i({type:Boolean,reflect:!0})],ie.prototype,"isCompactExpanded"),customElements.get("nys-stepper")||customElements.define("nys-stepper",ie);const Xs=g`
  :host {
    /* Anything that can be overridden should be defined here */
...
`,vo=`<svg xmlns="http://www.w3.org/2000/svg" width="91" height="55" viewBox="0 0 91 55" fill="none">
  ...
  <path d="M69.4282 52.8659C69.4135 52.8748 69.3891 52.8858 69.3471 52.8858C69.3178 52.8858 69.2837 52.8798 69.27 52.8659L68.9889 52.1476C68.9723 52.1088 68.9459 52.0323 68.944 52.0214C68.944 52.0264 68.9371 52.1277 68.9332 52.1565L68.8815 52.9205C68.8815 52.9205 68.8561 52.9404 68.7858 52.9404C68.7155 52.9404 68.6862 52.9205 68.6862 52.9205L68.7839 51.6787C68.7839 51.6787 68.8112 51.6588 68.8776 51.6588C68.9518 51.6588 68.9781 51.6787 68.9781 51.6787L69.3042 52.5162L69.3471 52.6533C69.3481 52.6473 69.3774 52.5559 69.392 52.5162L69.7181 51.6787C69.7181 51.6787 69.7464 51.6588 69.8206 51.6588C69.886 51.6588 69.9124 51.6787 69.9124 51.6787L70.01 52.9205C70.01 52.9205 69.9807 52.9404 69.9104 52.9404C69.8401 52.9404 69.8167 52.9205 69.8167 52.9205L69.763 52.1546L69.7523 52.0194C69.7523 52.0194 69.722 52.1148 69.7093 52.1456L69.4282 52.8659Z" fill="#154973"/>
        ...
        >
          <div class="content">
            ...
            <nys-button
              ...
              size="sm"
              suffixIcon="slotted"
              @keydown="${e=>{(e.code==="Enter"||e.code==="Space"||e.key==="Enter"||e.key===" ")&&(e.preventDefault(),e.stopPropagation(),this._toggleTrustbar())}}"
            >
              <nys-icon
                slot="suffix-icon"
                size="12"
    ...
    `}};At.styles=po;let K=At;De([i({type:Boolean})],K.prototype,"trustbarVisible"),De([i({type:Boolean})],K.prototype,"searchDropdownVisible"),De([i({type:Boolean})],K.prototype,"languageVisible"),De([i({type:Boolean})],K.prototype,"isSearchFocused"),De([i({type:Boolean})],K.prototype,"hideTranslate"),De([i({type:Boolean})],K.prototype,"hideSearch"),De([i({type:Array,reflect:!0})],K.prototype,"languages"),customElements.get("nys-unavheader")||customElements.define("nys-unavheader",K);const go=g`
  :host {
...
`;var bo=Object.defineProperty,Ye=(a,e,t,o)=>{for(var s=void 0,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=n(e,t,s)||s);return s&&bo(e,t,s),s};const Dt=class Dt extends p{constructor(){super(...arguments),this.appName="",this.agencyName="",this.homepageLink="",this.slotHasContent=!0,this.isMobileMenuOpen=!1}firstUpdated(){this.shadowRoot?.querySelector("slot")?.addEventListener("slotchange",()=>this._handleSlotChange()),this._handleSlotChange(),this._listenLinkClicks()}async _handleSlotChange(){const e=this.shadowRoot?.querySelector("slot");if(!e)return;const t=e?.assignedNodes({flatten:!0}).filter(r=>r.nodeType===Node.ELEMENT_NODE);await Promise.resolve(),this.slotHasContent=t.length>0;const o=this.shadowRoot?.querySelector(".nys-globalheader__content"),s=this.shadowRoot?.querySelector(".nys-globalheader__content-mobile");if(o&&s){o.innerHTML="",s.innerHTML="";const r=this._normalizePath(window.location.pathname+window.location.hash);t.forEach(n=>{if(n.nodeType===Node.ELEMENT_NODE){const c=n.cloneNode(!0),d=n.cloneNode(!0);["script","iframe","object","embed, img"].forEach(v=>{c.querySelectorAll(v).forEach(w=>w.remove())});const f=v=>{const w=Array.from(v.querySelectorAll("a"));let q={li:null,length:0};w.forEach(ue=>{const y1=ue.getAttribute("href"),Xe=this._normalizePath(y1);Xe&&(Xe==="/"&&r==="/"?q={li:ue.closest("li"),length:1}:r?.startsWith(Xe)&&Xe.length>q.length&&(q={li:ue.closest("li"),length:Xe.length}),w.forEach(wo=>wo.closest("li")?.classList.remove("active")),q.li?.classList.add("active"))})};f(c),f(d),o.appendChild(c),s.appendChild(d),n.remove()}})}}_normalizePath(e){if(e)return e.startsWith("/")||(e="/"+e),e.length>1&&e.endsWith("/")&&(e=e.slice(0,-1)),e.toLowerCase()}_toggleMobileMenu(){this.isMobileMenuOpen=!this.isMobileMenuOpen}_listenLinkClicks(){this.shadowRoot?.querySelectorAll(".nys-globalheader__content, .nys-globalheader__content-mobile")?.forEach(t=>{t?.addEventListener("click",o=>{const r=o.target.closest("a");if(!r)return;t.querySelectorAll("li.active").forEach(c=>c.classList.remove("active"));const n=r.closest("li");n&&n.classList.add("active")})})}render(){return l`
      ...
      ></div>
    `}};Dt.styles=go;let ae=Dt;Ye([i({type:String})],ae.prototype,"appName"),Ye([i({type:String})],ae.prototype,"agencyName"),Ye([i({type:String})],ae.prototype,"homepageLink"),Ye([M()],ae.prototype,"slotHasContent"),Ye([M()],ae.prototype,"isMobileMenuOpen"),customElements.get("nys-globalheader")||customElements.define("nys-globalheader",ae);const _o=g`
  :host {
...
`,xo=`<svg xmlns="http://www.w3.org/2000/svg" width="91" height="55" viewBox="0 0 91 55" fill="none">
  ...
  <path d="M69.4282 52.8659C69.4135 52.8748 69.3891 52.8858 69.3471 52.8858C69.3178 52.8858 69.2837 52.8798 69.27 52.8659L68.9889 52.1476C68.9723 52.1088 68.9459 52.0323 68.944 52.0214C68.944 52.0264 68.9371 52.1277 68.9332 52.1565L68.8815 52.9205C68.8815 52.9205 68.8561 52.9404 68.7858 52.9404C68.7155 52.9404 68.6862 52.9205 68.6862 52.9205L68.7839 51.6787C68.7839 51.6787 68.8112 51.6588 68.8776 51.6588C68.9518 51.6588 68.9781 51.6787 68.9781 51.6787L69.3042 52.5162L69.3471 52.6533C69.3481 52.6473 69.3774 52.5559 69.392 52.5162L69.7181 51.6787C69.7181 51.6787 69.7464 51.6588 69.8206 51.6588C69.886 51.6588 69.9124 51.6787 69.9124 51.6787L70.01 52.9205C70.01 52.9205 69.9807 52.9404 69.9104 52.9404C69.8401 52.9404 69.8167 52.9205 69.8167 52.9205L69.763 52.1546L69.7523 52.0194C69.7523 52.0194 69.722 52.1148 69.7093 52.1456L69.4282 52.8659Z" fill="white"/>
    ...
    `}};zt.styles=mo;let rt=zt;customElements.get("nys-unavfooter")||customElements.define("nys-unavfooter",rt),u.NysAccordion=$e,u.NysAccordionItem=te,u.NysAlert=Kt,u.NysAvatar=O,u.NysBacktotop=fe,u.NysBadge=Xt,u.NysButton=Yt,u.NysCheckbox=e1,u.NysCheckboxgroup=Jt,u.NysDivider=je,u.NysErrorMessage=Se,u.NysFileinput=k,u.NysGlobalFooter=Me,u.NysGlobalHeader=ae,u.NysIcon=t1,u.NysLabel=J,u.NysModal=s1,u.NysOption=ne,u.NysPagination=re,u.NysRadiobutton=n1,u.NysRadiogroup=r1,u.NysSelect=i1,u.NysSkipnav=Pe,u.NysStep=G,u.NysStepper=ie,u.NysTextarea=c1,u.NysTextinput=d1,u.NysToggle=h1,u.NysTooltip=ee,u.NysUnavFooter=rt,u.NysUnavHeader=K,Object.defineProperty(u,Symbol.toStringTag,{value:"Module"})}));
