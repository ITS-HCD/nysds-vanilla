 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function xt(a,e){return(t,o,s)=>{const i=n=>{var c;return((c=n.renderRoot)==null?void 0:c.querySelector(a))??null};return mt(t,o,{get(){return i(this)}})}}const Ze=v`
  :host {
...
`;var wt=Object.defineProperty,q1=(a,e,t,o)=>{for(var s=void 0,i=a.length-1,n;i>=0;i--)(n=a[i])&&(s=n(e,t,s)||s);return s&&wt(e,t,s),s};let kt=0;const de=class de extends f{constructor(){super(),this.id="",this.heading="",this.expanded=!1,this.bordered=!1}connectedCallback(){super.connectedCallback(),this.id||(this.id=this._generateUniqueId())}updated(e){e.has("expanded")&&this._updateHeight()}_generateUniqueId(){return`nys-accordionitem-${Date.now()}-${kt++}`}_dispatchEvent(){this.dispatchEvent(new CustomEvent("nys-accordionitem-toggle",{detail:{id:this.id,heading:this.heading,expanded:this.expanded},bubbles:!0,composed:!0}))}_handleExpand(){this.expanded=!this.expanded,this._updateHeight(),this._dispatchEvent()}_handleKeydown(e){(e.key===" "||e.key==="Enter")&&(e.preventDefault(),this._handleExpand())}_updateHeight(){if(this._contentContainer)if(this.expanded){const e=this._contentContainer.scrollHeight;this._contentContainer.style.height=`${e}px`}else this._contentContainer.style.height="0",this._contentContainer.style.overflow="hidden"}render(){const e=`${this.id}-content`;return l`<div id=${this.id} class="nys-accordionitem">
    ...
    </div>`}};de.styles=Ze;let J=de;q1([r({type:String})],J.prototype,"id"),q1([r({type:String})],J.prototype,"heading"),q1([r({type:Boolean,reflect:!0})],J.prototype,"expanded"),q1([r({type:Boolean,reflect:!0})],J.prototype,"bordered"),q1([xt(".nys-accordionitem__content")],J.prototype,"_contentContainer"),customElements.get("nys-accordionitem")||customElements.define("nys-accordionitem",J);var $t=Object.defineProperty,ae=(a,e,t,o)=>{for(var s=void 0,i=a.length-1,n;i>=0;i--)(n=a[i])&&(s=n(e,t,s)||s);return s&&$t(e,t,s),s};let St=0;const he=class he extends f{constructor(){super(),this.id="",this.singleSelect=!1,this.bordered=!1}connectedCallback(){super.connectedCallback(),this.id||(this.id=this._generateUniqueId())}updated(e){e.has("bordered")&&this._applyBordered()}_generateUniqueId(){return`nys-accordionitem-${Date.now()}-${St++}`}_getAccordions(){var o;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("slot");return((e==null?void 0:e.assignedElements())||[]).filter(s=>s.tagName.toLowerCase()==="nys-accordionitem")}_onAccordionToggle(e){if(!this.singleSelect)return;const t=e.detail.id;e.detail.expanded&&this._getAccordions().forEach(s=>{s.id!==t&&s.expanded&&(s.expanded=!1)})}_applyBordered(){this._getAccordions().forEach(e=>{e.bordered=this.bordered})}render(){return l`<div
      id=${this.id}
      class="nys-accordion"
      @nys-accordionitem-toggle=${this._onAccordionToggle}
    >
      <slot></slot>
    </div>`}};he.styles=Ze;let m1=he;ae([r({type:String})],m1.prototype,"id"),ae([r({type:Boolean,reflect:!0})],m1.prototype,"singleSelect"),ae([r({type:Boolean,reflect:!0})],m1.prototype,"bordered"),customElements.get("nys-accordion")||customElements.define("nys-accordion",m1);const Lt=v`
  :host {
    /* Global Alert Styles */
...
`;var Xt=Object.defineProperty,le=(a,e,t,o)=>{for(var s=void 0,i=a.length-1,n;i>=0;i--)(n=a[i])&&(s=n(e,t,s)||s);return s&&Xt(e,t,s),s};const X1=class X1 extends f{constructor(){super(),this.showError=!1,this.errorMessage="",this.showDivider=!1,this._internals=this.attachInternals()}render(){return l`${this.showError?l`<div class="nys-errormessage" ?showDivider=${this.showDivider}>
...
`;var t2=Object.defineProperty,Y1=(a,e,t,o)=>{for(var s=void 0,i=a.length-1,n;i>=0;i--)(n=a[i])&&(s=n(e,t,s)||s);return s&&t2(e,t,s),s};const ue=class ue extends f{constructor(){super(...arguments),this.filename="",this.status="pending",this.progress=0,this.errorMessage=""}_handleRemove(){this.dispatchEvent(new CustomEvent("nys-fileRemove",{detail:{filename:this.filename},bubbles:!0,composed:!0}))}splitFilename(e){const t=e.lastIndexOf("."),o=t!==-1?e.slice(t):"",s=t!==-1?e.slice(0,t):e,i=s.slice(0,s.length-3),n=s.slice(-3);return{startPart:i,endPart:n,extension:o}}render(){const{startPart:e,endPart:t,extension:o}=this.splitFilename(this.filename);return l`
      <div
...
`;var c2=Object.defineProperty,W1=(a,e,t,o)=>{for(var s=void 0,i=a.length-1,n;i>=0;i--)(n=a[i])&&(s=n(e,t,s)||s);return s&&c2(e,t,s),s};const pe=class pe extends f{constructor(){super(...arguments),this.id="",this.label="",this.description="",this.flag=""}render(){return l`
      <div class="nys-label">
    ...
    `}};pe.styles=l2;let u1=pe;W1([r({type:String})],u1.prototype,"id"),W1([r({type:String})],u1.prototype,"label"),W1([r({type:String})],u1.prototype,"description"),W1([r({type:String})],u1.prototype,"flag"),customElements.get("nys-label")||customElements.define("nys-label",u1);const Fe=v`
  :host {
...
`;var x2=Object.defineProperty,We=(a,e,t,o)=>{for(var s=void 0,i=a.length-1,n;i>=0;i--)(n=a[i])&&(s=n(e,t,s)||s);return s&&x2(e,t,s),s};const fe=class fe extends f{constructor(){super(),this.id="",this.href=""}connectedCallback(){super.connectedCallback(),this.id||(this.id=`nys-skipnav-${Date.now()}`)}_handleFocus(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".nys-skipnav__link");e==null||e.classList.add("show")}_handleBlur(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".nys-skipnav__link");e==null||e.classList.remove("show")}_handleClick(){const e=(this.href||"#main-content").replace("#",""),t=document.getElementById(e);t&&(t.setAttribute("tabindex","-1"),t.focus(),t.style.outline="none")}render(){return l`
...
${this.value}</textarea
    ...
    `}},j.VALID_WIDTHS=["sm","md","lg","full"],j.VALID_RESIZE=["vertical","none"],j.styles=w2,j.formAssociated=!0,j);S([r({type:String})],k.prototype,"id",2),S([r({type:String,reflect:!0})],k.prototype,"name",2),S([r({type:String})],k.prototype,"label",2),S([r({type:String})],k.prototype,"description",2),S([r({type:String})],k.prototype,"placeholder",2),S([r({type:String})],k.prototype,"value",2),S([r({type:Boolean,reflect:!0})],k.prototype,"disabled",2),S([r({type:Boolean,reflect:!0})],k.prototype,"readonly",2),S([r({type:Boolean,reflect:!0})],k.prototype,"required",2),S([r({type:Boolean,reflect:!0})],k.prototype,"optional",2),S([r({type:String})],k.prototype,"form",2),S([r({type:Number})],k.prototype,"maxlength",2),S([r({reflect:!0})],k.prototype,"width",2),S([r({type:Number})],k.prototype,"rows",2),S([r({reflect:!0})],k.prototype,"resize",1),S([r({type:Boolean,reflect:!0})],k.prototype,"showError",2),S([r({type:String})],k.prototype,"errorMessage",2);let Ke=k;customElements.get("nys-textarea")||customElements.define("nys-textarea",Ke);const L2=v`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;var E2=Object.defineProperty,D2=Object.getOwnPropertyDescriptor,m=(a,e,t,o)=>{for(var s=o>1?void 0:o?D2(e,t):e,i=a.length-1,n;i>=0;i--)(n=a[i])&&(s=(o?n(e,t,s):n(s))||s);return o&&s&&E2(e,t,s),s};let M2=0;const C=(G=class extends f{constructor(){super(),this.id="",this.name="",this._type="text",this.label="",this.description="",this.placeholder="",this.value="",this.disabled=!1,this.readonly=!1,this.required=!1,this.optional=!1,this.form="",this.pattern="",this.maxlength=null,this.width="full",this.step=null,this.min=null,this.max=null,this.showError=!1,this.errorMessage="",this.showPassword=!1,this._originalErrorMessage="",this._hasUserInteracted=!1,this._maskPatterns={tel:"(___) ___-____"},this._internals=this.attachInternals()}get type(){return this._type}set type(e){this._type=G.VALID_TYPES.includes(e)?e:"text"}async updated(e){var t,o;if(e.has("width")&&(await Promise.resolve(),this.width=G.VALID_WIDTHS.includes(this.width)?this.width:"full"),e.has("disabled")&&(this._validateButtonSlot("startButton"),this._validateButtonSlot("endButton")),e.has("type")){const s=this._maskPatterns[this.type],i=(t=this.shadowRoot)==null?void 0:t.querySelector("input");if(i)if(s)i.maxLength=s.length,this._updateOverlay(i.value,s);else{i.removeAttribute("maxLength");const n=(o=this.shadowRoot)==null?void 0:o.querySelector(".nys-textinput__mask-overlay");n&&(n.textContent="")}}}connectedCallback(){super.connectedCallback(),this.id||(this.id=`nys-textinput-${Date.now()}-${M2++}`),this._originalErrorMessage=this.errorMessage??"",this.addEventListener("invalid",this._handleInvalid)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("invalid",this._handleInvalid)}firstUpdated(){this._setValue()}formResetCallback(){this.value=""}_setValue(){this._internals.setFormValue(this.value),this._manageRequire()}_manageRequire(){var s,i;const e=(s=this.shadowRoot)==null?void 0:s.querySelector("input");if(!e)return;const t=this.errorMessage||"This field is required";this.required&&(!this.value||((i=this.value)==null?void 0:i.trim())==="")?(this._internals.ariaRequired="true",this._internals.setValidity({valueMissing:!0},t,e)):(this._internals.ariaRequired="false",this._internals.setValidity({}),this._hasUserInteracted=!1)}_setValidityMessage(e=""){var s,i;const t=(s=this.shadowRoot)==null?void 0:s.querySelector("input");if(!t)return;this.showError=!!e,(i=this._originalErrorMessage)!=null&&i.trim()&&e!==""?this.errorMessage=this._originalErrorMessage:this.errorMessage=e;const o=e?{customError:!0}:{};this._internals.setValidity(o,this.errorMessage,t)}_validate(){var s;const e=(s=this.shadowRoot)==null?void 0:s.querySelector("input");if(!e)return;const t=e.validity;let o="";t.valueMissing?o="This field is required":t.typeMismatch?o="Invalid format for this type":t.patternMismatch?o="Invalid format":t.tooShort?o=`Value is too short. Minimum length is ${e.minLength}`:t.tooLong?o=`Value is too long. Maximum length is ${e.maxLength}`:t.rangeUnderflow?o=`Value must be at least ${e.min}`:t.rangeOverflow?o=`Value must be at most ${e.max}`:t.stepMismatch?o="Invalid step value":o=e.validationMessage,this._setValidityMessage(o)}checkValidity(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("input");return e?e.checkValidity():!0}_handleInvalid(e){var o;e.preventDefault(),this._hasUserInteracted=!0,this._validate();const t=(o=this.shadowRoot)==null?void 0:o.querySelector("input");if(t){const s=this._internals.form;s?Array.from(s.elements).find(c=>typeof c.checkValidity=="function"&&!c.checkValidity())===this&&t.focus():t.focus()}}_togglePasswordVisibility(){this.showPassword=!this.showPassword}_updateOverlay(e,t){var n;const o=(n=this.shadowRoot)==null?void 0:n.querySelector(".nys-textinput__mask-overlay");if(!o)return;const s=e,i=t.slice(s.length);o.textContent=s+i}_applyMask(e,t){const o=e.replace(/\D/g,"");let s="";if(this.type==="tel")return o.length>0&&(s="("+o.substring(0,3)),o.length>=4&&(s+=") "+o.substring(3,6)),o.length>6&&(s+="-"+o.substring(6,10)),s;let i=0;for(let n=0;n<t.length;n++)if(t[n]==="_"||t[n].match(/[d9]/i))if(i<o.length)s+=o[i++];else break;else s+=t[n];return s}_handleInput(e){const t=e.target;let o=t.value;const s=this._maskPatterns[this.type];s&&(o=this._applyMask(o,s),t.value=o,this._updateOverlay(o,s)),this.value=o,this._internals.setFormValue(this.value),this._hasUserInteracted&&this._validate(),this.dispatchEvent(new CustomEvent("nys-input",{detail:{value:this.value},bubbles:!0,composed:!0}))}_handleFocus(){this.dispatchEvent(new Event("nys-focus"))}_handleBlur(){this._hasUserInteracted||(this._hasUserInteracted=!0),this._validate(),this.dispatchEvent(new Event("nys-blur"))}_validateButtonSlot(e){var n,c;const t=(n=this.shadowRoot)==null?void 0:n.querySelector('slot[name="'+e+'"]'),o=(c=this.shadowRoot)==null?void 0:c.querySelector(".nys-textinput__buttoncontainer");if(!t||!o)return;const s=t.assignedElements();let i=!1;s.forEach(d=>{d instanceof HTMLElement&&d.tagName.toLowerCase()==="nys-button"&&!i?(i=!0,d.setAttribute("size","sm"),d.setAttribute("variant","primary"),this.disabled?d.setAttribute("disabled","true"):d.removeAttribute("disabled")):(console.warn("The '"+e+"' slot only accepts a single <nys-button> element. Removing invalid or extra node:",d),d.remove())}),e==="startButton"?o.classList.toggle("has-start-button",i):e==="endButton"&&o.classList.toggle("has-end-button",i)}render(){return l`
...
`;var T2=Object.defineProperty,R1=(a,e,t,o)=>{for(var s=void 0,i=a.length-1,n;i>=0;i--)(n=a[i])&&(s=n(e,t,s)||s);return s&&T2(e,t,s),s};const Ce=class Ce extends f{constructor(){super(...arguments),this.appName="",this.agencyName="",this.homepageLink="",this.slotHasContent=!0,this.isMobileMenuOpen=!1}firstUpdated(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("slot");e==null||e.addEventListener("slotchange",()=>this._handleSlotChange()),this._handleSlotChange()}async _handleSlotChange(){var i,n,c;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("slot");if(!e)return;const t=e==null?void 0:e.assignedNodes({flatten:!0}).filter(d=>d.nodeType===Node.ELEMENT_NODE);await Promise.resolve(),this.slotHasContent=t.length>0;const o=(n=this.shadowRoot)==null?void 0:n.querySelector(".nys-globalheader__content"),s=(c=this.shadowRoot)==null?void 0:c.querySelector(".nys-globalheader__content-mobile");o&&s&&(o.innerHTML="",s.innerHTML="",t.forEach(d=>{if(d.nodeType===Node.ELEMENT_NODE){const y=d.cloneNode(!0),g=d.cloneNode(!0);["script","iframe","object","embed, img"].forEach(L=>{y.querySelectorAll(L).forEach(Q=>Q.remove())});const O=this._normalizePath(window.location.pathname);y.querySelectorAll("a").forEach(L=>{const Q=L.getAttribute("href");if(this._normalizePath(Q)===O){const T1=L.closest("li");T1&&T1.classList.add("active")}}),g.querySelectorAll("a").forEach(L=>{const Q=L.getAttribute("href");if(this._normalizePath(Q)===O){const T1=L.closest("li");T1&&T1.classList.add("active")}}),o.appendChild(y),s.appendChild(g),d.remove()}}))}_normalizePath(e){if(e)return e.startsWith("/")||(e="/"+e),e.length>1&&e.endsWith("/")&&(e=e.slice(0,-1)),e.toLowerCase()}_toggleMobileMenu(){this.isMobileMenuOpen=!this.isMobileMenuOpen}render(){var e,t,o,s,i,n,c,d;return l`
...
`;var F2=Object.defineProperty,ce=(a,e,t,o)=>{for(var s=void 0,i=a.length-1,n;i>=0;i--)(n=a[i])&&(s=n(e,t,s)||s);return s&&F2(e,t,s),s};const _e=class _e extends f{constructor(){super(...arguments),this.agencyName="",this.homepageLink="",this.slotHasContent=!0}firstUpdated(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("slot");e==null||e.addEventListener("slotchange",()=>this._handleSlotChange()),this._handleSlotChange()}async _handleSlotChange(){var i,n;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("slot");if(!e)return;const t=e==null?void 0:e.assignedNodes({flatten:!0}).filter(c=>c.nodeType===Node.ELEMENT_NODE);await Promise.resolve(),this.slotHasContent=t.length>0;const o=(n=this.shadowRoot)==null?void 0:n.querySelector(".nys-globalfooter__content"),s=t==null?void 0:t.some(c=>c.tagName==="H4");o&&(o.classList.toggle("columns",s),o.classList.toggle("small",!s),o.innerHTML="",t.forEach(c=>{if(c.nodeType===Node.ELEMENT_NODE){const d=c.cloneNode(!0);["script","iframe","object","embed","img"].forEach(g=>{d.querySelectorAll(g).forEach(h=>h.remove())}),o.appendChild(d),c.remove()}}))}render(){var e,t;return l`
    ...
    `}};_e.styles=N2;let S1=_e;ce([r({type:String})],S1.prototype,"agencyName"),ce([r({type:String})],S1.prototype,"homepageLink"),ce([V()],S1.prototype,"slotHasContent"),customElements.get("nys-globalfooter")||customElements.define("nys-globalfooter",S1);const j2=v`
  :host {
    /* Global Footer Styles */
