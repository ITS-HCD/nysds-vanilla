...
`;var wt=Object.defineProperty,q1=(a,e,t,o)=>{for(var s=void 0,n=a.length-1,i;n>=0;n--)(i=a[n])&&(s=i(e,t,s)||s);return s&&wt(e,t,s),s};let kt=0;const de=class de extends f{constructor(){super(),this.id="",this.heading="",this.expanded=!1,this.bordered=!1}connectedCallback(){super.connectedCallback(),this.id||(this.id=this._generateUniqueId())}updated(e){e.has("expanded")&&this._updateHeight()}_generateUniqueId(){return`nys-accordionitem-${Date.now()}-${kt++}`}_dispatchEvent(){this.dispatchEvent(new CustomEvent("nys-accordionitem-toggle",{detail:{id:this.id,heading:this.heading,expanded:this.expanded},bubbles:!0,composed:!0}))}_handleExpand(){this.expanded=!this.expanded,this._updateHeight(),this._dispatchEvent()}_handleKeydown(e){(e.key===" "||e.key==="Enter")&&(e.preventDefault(),this._handleExpand())}_updateHeight(){if(this._contentContainer)if(this.expanded){const e=this._contentContainer.scrollHeight;this._contentContainer.style.height=`${e}px`}else this._contentContainer.style.height="0",this._contentContainer.style.overflow="hidden"}render(){const e=`${this.id}-content`;return l`<div id=${this.id} class="nys-accordionitem">
    ...
    </div>`}};de.styles=Ze;let J=de;q1([r({type:String})],J.prototype,"id"),q1([r({type:String})],J.prototype,"heading"),q1([r({type:Boolean,reflect:!0})],J.prototype,"expanded"),q1([r({type:Boolean,reflect:!0})],J.prototype,"bordered"),q1([xt(".nys-accordionitem__content")],J.prototype,"_contentContainer"),customElements.get("nys-accordionitem")||customElements.define("nys-accordionitem",J);var $t=Object.defineProperty,ae=(a,e,t,o)=>{for(var s=void 0,n=a.length-1,i;n>=0;n--)(i=a[n])&&(s=i(e,t,s)||s);return s&&$t(e,t,s),s};let St=0;const he=class he extends f{constructor(){super(),this.id="",this.singleSelect=!1,this.bordered=!1}connectedCallback(){super.connectedCallback(),this.id||(this.id=this._generateUniqueId())}updated(e){e.has("bordered")&&this._applyBordered()}_generateUniqueId(){return`nys-accordionitem-${Date.now()}-${St++}`}_getAccordions(){var o;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("slot");return((e==null?void 0:e.assignedElements())||[]).filter(s=>s.tagName.toLowerCase()==="nys-accordionitem")}_onAccordionToggle(e){if(!this.singleSelect)return;const t=e.detail.id;e.detail.expanded&&this._getAccordions().forEach(s=>{s.id!==t&&s.expanded&&(s.expanded=!1)})}_applyBordered(){this._getAccordions().forEach(e=>{e.bordered=this.bordered})}render(){return l`<div
      id=${this.id}
      class="nys-accordion"
...
`;var c2=Object.defineProperty,W1=(a,e,t,o)=>{for(var s=void 0,n=a.length-1,i;n>=0;n--)(i=a[n])&&(s=i(e,t,s)||s);return s&&c2(e,t,s),s};const pe=class pe extends f{constructor(){super(...arguments),this.id="",this.label="",this.description="",this.flag=""}render(){return l`
      <div class="nys-label">
...
`;var T2=Object.defineProperty,R1=(a,e,t,o)=>{for(var s=void 0,n=a.length-1,i;n>=0;n--)(i=a[n])&&(s=i(e,t,s)||s);return s&&T2(e,t,s),s};const Ce=class Ce extends f{constructor(){super(...arguments),this.appName="",this.agencyName="",this.homepageLink="",this.slotHasContent=!0,this.isMobileMenuOpen=!1}firstUpdated(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("slot");e==null||e.addEventListener("slotchange",()=>this._handleSlotChange()),this._handleSlotChange()}async _handleSlotChange(){var n,i,c;const e=(n=this.shadowRoot)==null?void 0:n.querySelector("slot");if(!e)return;const t=e==null?void 0:e.assignedNodes({flatten:!0}).filter(d=>d.nodeType===Node.ELEMENT_NODE);await Promise.resolve(),this.slotHasContent=t.length>0;const o=(i=this.shadowRoot)==null?void 0:i.querySelector(".nys-globalheader__content"),s=(c=this.shadowRoot)==null?void 0:c.querySelector(".nys-globalheader__content-mobile");o&&s&&(o.innerHTML="",s.innerHTML="",t.forEach(d=>{if(d.nodeType===Node.ELEMENT_NODE){const y=d.cloneNode(!0),g=d.cloneNode(!0);["script","iframe","object","embed, img"].forEach(L=>{y.querySelectorAll(L).forEach(Q=>Q.remove())});const O=this._normalizePath(window.location.pathname);y.querySelectorAll("a").forEach(L=>{const Q=L.getAttribute("href");if(this._normalizePath(Q)===O){const T1=L.closest("li");T1&&T1.classList.add("active")}}),g.querySelectorAll("a").forEach(L=>{const Q=L.getAttribute("href");if(this._normalizePath(Q)===O){const T1=L.closest("li");T1&&T1.classList.add("active")}}),o.appendChild(y),s.appendChild(g),d.remove()}}))}_normalizePath(e){if(e)return e.startsWith("/")||(e="/"+e),e.length>1&&e.endsWith("/")&&(e=e.slice(0,-1)),e.toLowerCase()}_toggleMobileMenu(){this.isMobileMenuOpen=!this.isMobileMenuOpen}render(){var e,t,o,s,n,i,c,d;return l`
