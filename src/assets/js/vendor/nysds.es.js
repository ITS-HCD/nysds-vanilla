...
const Fe = class Fe extends u {
  ...
  // Functions
  _generateUniqueId() {
    return `nys-accordionitem-${Date.now()}-${b1++}`;
  }
  _dispatchEvent() {
    this.dispatchEvent(
...
], J.prototype, "expanded");
Ce([
  n({ type: Boolean, reflect: !0 })
], J.prototype, "bordered");
Ce([
  f1(".nys-accordionitem__content")
], J.prototype, "_contentContainer");
customElements.get("nys-accordionitem") || customElements.define("nys-accordionitem", J);
var _1 = Object.defineProperty, Ue = (a, e, t, o) => {
  for (var s = void 0, r = a.length - 1, i; r >= 0; r--)
    (i = a[r]) && (s = i(e, t, s) || s);
  return s && _1(e, t, s), s;
};
...
const je = class je extends u {
  ...
  getContrastForeground() {
    ...
    const c = i.match(/\d+/g);
    if (!c) return;
    const d = Number(c[0]), h = Number(c[1]), b = Number(c[2]), w = (0.299 * d + 0.587 * h + 0.114 * b) / 255 < 0.5;
    return this.initials?.length > 0 ? w ? s : o : w ? t : e;
  }
  render() {
    return l`
...
const S1 = ".nys-backtotop{--_nys-button-border-radius--start: var(--nys-radius-round, 1776px);--_nys-button-border-radius--end: var(--nys-radius-round, 1776px);--_nys-button-padding--y: var(--nys-space-100, 8px);--_nys-button-padding--x: var(--nys-space-200, 16px);position:fixed;bottom:1rem;right:1rem;z-index:9999;display:none}.left{left:1rem;right:auto}.visible{display:inline-flex}";
var E1 = Object.defineProperty, Ze = (a, e, t, o) => {
  for (var s = void 0, r = a.length - 1, i; r >= 0; r--)
    (i = a[r]) && (s = i(e, t, s) || s);
  return s && E1(e, t, s), s;
};
...
Se.styles = p(M1), Se.formAssociated = !0;
let f = Se;
C([
  n({ type: String, reflect: !0 })
], f.prototype, "id");
...
const Ee = class Ee extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-checkbox-${Date.now()}-${Z1++}`), this.addEventListener("nys-change", this._handleCheckboxChange), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
...
Ee.styles = p(h1), Ee.formAssociated = !0;
let E = Ee;
q([
  n({ type: String, reflect: !0 })
], E.prototype, "id");
...
q([
  z()
], E.prototype, "_slottedDescriptionText");
customElements.get("nys-checkboxgroup") || customElements.define("nys-checkboxgroup", E);
var I1 = Object.defineProperty, D = (a, e, t, o) => {
  for (var s = void 0, r = a.length - 1, i; r >= 0; r--)
    (i = a[r]) && (s = i(e, t, s) || s);
  return s && I1(e, t, s), s;
};
...
const Me = class Me extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-checkbox-${Date.now()}-${P1++}`), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
...
Me.styles = p(h1), Me.formAssociated = !0;
let k = Me;
D([
  n({ type: Boolean, reflect: !0 })
], k.prototype, "checked");
...
var R1 = Object.defineProperty, O1 = (a, e, t, o) => {
  for (var s = void 0, r = a.length - 1, i; r >= 0; r--)
    (i = a[r]) && (s = i(e, t, s) || s);
  return s && R1(e, t, s), s;
};
...
ze.styles = p(F1), ze.formAssociated = !0;
let ye = ze;
Re([
  n({ type: Boolean })
...
Re([
  n({ type: Boolean, reflect: !0 })
], ye.prototype, "showDivider");
customElements.get("nys-errormessage") || customElements.define("nys-errormessage", ye);
async function T1(a, e) {
...
const Ve = class Ve extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-fileinput-${Date.now()}-${Y1++}`), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
  }
  ...
  async _processFile(e) {
    e.status = "processing";
    try {
      if (!await T1(e.file, this.accept)) {
...
Ve.styles = p(G1), Ve.formAssociated = !0;
let L = Ve;
B([
  n({ type: String, reflect: !0 })
], L.prototype, "id");
...
const Qe = class Qe extends u {
  ...
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-{{componentName}}-${Date.now()}-${nt++}`), window.addEventListener("resize", () => this._updateSlottedButtonWidth()), window.addEventListener("keydown", (e) => this._handleKeydown(e));
  }
  disconnectedCallback() {
  ...
  async _handleKeydown(e) {
    if (this.open && (e.key === "Escape" && !this.mandatory && (e.preventDefault(), this._closeModal()), e.key === "Tab")) {
      ...
      if (s.length > 0) {
        ...
        let h = document.activeElement, b = s.indexOf(h);
        if (e.shiftKey) {
          e.preventDefault();
          let m = b - 1;
          m < 0 && (m = s.length - 1);
          const w = s[m];
          s[m].tagName.toLowerCase() === "nys-button" ? (await w.getButtonElement())?.focus() : w.focus();
        } else
          h === d && (e.preventDefault(), c.tagName.toLowerCase() === "nys-button" ? (await c.getButtonElement())?.focus() : c.focus());
      }
    }
  }
  _closeModal() {
...
const Je = class Je extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-pagination-${Date.now()}-${lt++}`);
  }
  // Functions
  _clampPage(e) {
...
const De = class De extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-radiogroup-${Date.now()}-${dt++}`), this.addEventListener("nys-change", this._handleRadioButtonChange), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
  ...
  async _handleKeyDown(e) {
    ...
    e.preventDefault();
    const o = this._getAllRadios().filter((h) => !h.disabled), s = o.find((h) => h.checked) || o[0], r = e.key === " " || e.key === "Enter" ? 0 : ["ArrowUp", "ArrowLeft"].includes(e.key) ? -1 : 1;
    let i = o.indexOf(s) + r;
...
De.styles = p(y1), De.formAssociated = !0;
let S = De;
H([
  n({ type: String, reflect: !0 })
], S.prototype, "id");
...
var ht = Object.defineProperty, R = (a, e, t, o) => {
  for (var s = void 0, r = a.length - 1, i; r >= 0; r--)
    (i = a[r]) && (s = i(e, t, s) || s);
  return s && ht(e, t, s), s;
};
...
const U = (x = class extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-radiobutton-${Date.now()}-${yt++}`), this.checked && (x.buttonGroup[this.name] && (x.buttonGroup[this.name].checked = !1, x.buttonGroup[this.name].requestUpdate()), x.buttonGroup[this.name] = this), this.addEventListener("focus", this._handleFocus), this.addEventListener("blur", this._handleBlur), this.addEventListener("click", this._handleChange);
  }
  disconnectedCallback() {
...
let ut = U;
customElements.get("nys-radiobutton") || customElements.define("nys-radiobutton", ut);
var pt = Object.defineProperty, xe = (a, e, t, o) => {
  for (var s = void 0, r = a.length - 1, i; r >= 0; r--)
    (i = a[r]) && (s = i(e, t, s) || s);
  return s && pt(e, t, s), s;
};
...
const Be = class Be extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-select-${Date.now()}-${gt++}`), this._originalErrorMessage = this.errorMessage ?? "", this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
  }
...
Be.styles = p(vt), Be.formAssociated = !0;
let M = Be;
Z([
  n({ type: String, reflect: !0 })
], M.prototype, "id");
...
customElements.get("nys-skipnav") || customElements.define("nys-skipnav", _e);
...
var Ct = Object.defineProperty, ce = (a, e, t, o) => {
  for (var s = void 0, r = a.length - 1, i; r >= 0; r--)
    (i = a[r]) && (s = i(e, t, s) || s);
  return s && Ct(e, t, s), s;
};
...
var mt = Object.defineProperty, we = (a, e, t, o) => {
  for (var s = void 0, r = a.length - 1, i; r >= 0; r--)
    (i = a[r]) && (s = i(e, t, s) || s);
  return s && mt(e, t, s), s;
};
const s1 = class s1 extends u {
  ...
  willUpdate() {
    ...
    let t = !1, o = !1, s = !1;
    e.forEach((r, i) => {
      r.hasAttribute("current") && (s ? r.removeAttribute("current") : s = !0), i === 0 ? r.setAttribute("first", "") : r.removeAttribute("first"), r.hasAttribute("current") ? (t = !0, r.removeAttribute("previous")) : t ? r.removeAttribute("previous") : r.setAttribute("previous", ""), r.hasAttribute("selected") && (t || o ? r.removeAttribute("selected") : o = !0), this.isCompactExpanded ? r.setAttribute("isCompactExpanded", "") : r.removeAttribute("isCompactExpanded");
    }), o || (s ? e.forEach((r) => {
...
we([
  n({ type: String })
], se.prototype, "counterText");
we([
  n({ type: Boolean, reflect: !0 })
], se.prototype, "isCompactExpanded");
customElements.get("nys-stepper") || customElements.define("nys-stepper", se);
const xt = ':host{--_nys-table-width: 100%;--_nys-table-radius: var(--nys-radius-xl, 12px);--_nys-table-padding: var(--nys-space-100, 8px);--_nys-table-border-color: transparent;--_nys-table-border-width: 0;--_nys-table-font-family: var(--nys-font-family-ui, var(--nys-font-family-sans, "Proxima Nova", "Helvetica Neue", Helvetica, Arial, sans-serif));--_nys-table-font-size: var(--nys-font-size-ui-md, 16px);--_nys-table-font-weight: var(--nys-font-weight-regular, 400);--_nys-table-line-height: 16px;--_nys-table-padding--caption: var(--nys-space-250, 20px) var(--nys-space-150, 12px);--_nys-table-font-size--caption: var(--nys-font-size-ui-lg, 18px);--_nys-table-font-weight--caption: var(--nys-font-weight-bold, 700);--_nys-table-padding--cell--x: var(--nys-space-150, 12px);--_nys-table-padding--cell--y: var(--nys-space-200, 16px);--_nys-table-background-color: var(--nys-color-ink-reverse, #fff);--_nys-table-background-color--striped: var(--nys-color-neutral-10, #f6f6f6)}:host([bordered]){--_nys-table-border-color: var(--nys-color-neutral-100, #d0d0ce);--_nys-table-border-width: var(--nys-space-1px, 1px)}.nys-table{width:var(--_nys-table-width);font:var(--_nys-table-font-weight) var(--_nys-table-font-size)/var(--_nys-table-line-height) var(--_nys-table-font-family)}.nys-table table{width:var(--_nys-table-width);border-collapse:collapse}.nys-table caption{padding:var(--_nys-table-padding--caption);font-size:var(--_nys-table-font-size--caption);font-weight:var(--_nys-table-font-weight--caption);text-align:start}.nys-table caption div{display:flex;justify-content:space-between;align-items:center}.nys-table td{padding:var(--_nys-table-padding--cell--y) var(--_nys-table-padding--cell--x);border:var(--_nys-table-border-width) solid var(--_nys-table-border-color)}.nys-table th{border:var(--_nys-table-border-width) solid var(--_nys-table-border-color);overflow:hidden;text-overflow:ellipsis;padding:var(--_nys-table-padding--cell--y) var(--_nys-table-padding--cell--x)}.nys-table th:has(nys-button){padding:0}.nys-table th p{margin:0}.nys-table th nys-button{margin:0;width:auto;justify-content:space-between;--_nys-button-border-width: 0;--_nys-button-border-radius--start: 0;--_nys-button-border-radius--end: 0;--_nys-button-padding--x: var(--_nys-table-padding--cell--x);--_nys-button-justify-content: space-between}.nys-table th.nys-table__sortedcolumn{background-color:var(--nys-color-theme-weak, #cddde9)}.nys-table td.nys-table__sortedcolumn{position:relative;z-index:0}.nys-table td.nys-table__sortedcolumn:after{content:"";position:absolute;inset:0;background-color:var(--nys-color-theme, #154973);opacity:.1;pointer-events:none;z-index:-1}:host([striped]) .nys-table tbody tr:nth-child(odd){background-color:var(--_nys-table-background-color--striped)}:host([sortable]) .nys-table th{cursor:pointer}';
var wt = Object.defineProperty, ie = (a, e, t, o) => {
  for (var s = void 0, r = a.length - 1, i; r >= 0; r--)
    (i = a[r]) && (s = i(e, t, s) || s);
  return s && wt(e, t, s), s;
};
...
const o1 = class o1 extends u {
  /**************** Lifecycle Methods ****************/
  constructor() {
    super(), this.id = "", this.name = "", this.striped = !1, this.sortable = !1, this.bordered = !1, this.download = "", this._sortColumn = null, this._sortDirection = "none";
  }
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-table-${Date.now()}-${kt++}`);
  }
  /******************** Functions ********************/
  ...
  _handleSlotChange() {
    ...
    t.innerHTML = "", e.assignedElements({ flatten: !0 }).forEach((s) => {
      if (s.tagName === "TABLE") {
        ...
        this._normalizeTable(r), this.sortable && this._addSortIcons(r), this.download && this._injectDownloadButton(r), t.appendChild(r);
        return;
      }
    });
  }
  _normalizeTable(e) {
    ...
    const r = Array.from(e.querySelectorAll("tr"));
    if (r.length === 0) return;
    const i = document.createElement("thead"), c = document.createElement("tbody"), d = r.findIndex((h) => h.querySelector("th"));
    if (d === -1)
      r.forEach((h) => c.appendChild(h));
    else {
      const h = r[d];
      h.querySelectorAll("th").forEach((b) => {
        Array.from(b.childNodes).forEach((m) => {
          if (m.nodeType === Node.TEXT_NODE && m.textContent?.trim()) {
            const w = document.createElement("p");
            w.textContent = m.textContent, b.replaceChild(w, m);
          }
        });
      }), i.appendChild(h), r.forEach((b, m) => {
        m !== d && c.appendChild(b);
      });
    }
    if (e.innerHTML = "", this.sortable) {
      s || (s = document.createElement("caption"));
      const h = document.createElement("span");
      h.style.display = "none", h.textContent = "Column headers with buttons are sortable.", s.appendChild(h);
    }
    s && e.appendChild(s), e.appendChild(i), e.appendChild(c);
  }
  _addSortIcons(e) {
  ...
  _sortTable(e, t, o) {
    ...
    r.sort((i, c) => {
      const d = i.children[t]?.textContent?.trim() ?? "", h = c.children[t]?.textContent?.trim() ?? "", b = Number(d), m = Number(h);
      let w;
      return !isNaN(b) && !isNaN(m) ? w = b - m : w = d.localeCompare(h), o === "asc" ? w : -w;
  ...
  _injectDownloadButton(e) {
    let t = e.querySelector("caption");
    t || (t = document.createElement("caption"), e.insertBefore(t, e.firstChild));
    let o = t.querySelector(".caption-row");
    if (!o) {
      for (o = document.createElement("div"); t.firstChild; )
        o.appendChild(t.firstChild);
      t.appendChild(o);
    }
    const s = document.createElement("nys-button");
    s.setAttribute("variant", "outline"), s.setAttribute("size", "sm"), s.setAttribute("prefixIcon", "download"), s.setAttribute("label", "Download"), s.setAttribute("id", `${this.id}-download-button`), s.onclick = () => this.downloadFile(), o.appendChild(s);
  }
  downloadFile() {
...
const He = class He extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-textarea-${Date.now()}-${St++}`), this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
  }
...
He.styles = p(Lt), He.formAssociated = !0;
let _ = He;
$([
  n({ type: String, reflect: !0 })
], _.prototype, "id");
...
const Ae = class Ae extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-textinput-${Date.now()}-${zt++}`), this._originalErrorMessage = this.errorMessage ?? "", this.addEventListener("invalid", this._handleInvalid);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
  }
...
Ae.styles = p(Et), Ae.formAssociated = !0;
let v = Ae;
g([
  n({ type: String, reflect: !0 })
], v.prototype, "id");
...
const qe = class qe extends u {
  ...
  // Generate a unique ID if one is not provided
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-toggle-${Date.now()}-${Bt++}`);
  }
  // Form Integration
...
qe.styles = p(Vt), qe.formAssociated = !0;
let A = qe;
N([
  n({ type: String, reflect: !0 })
], A.prototype, "id");
...
const r1 = class r1 extends u {
  ...
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `nys-tooltip-${Date.now()}-${Zt++}`), window.addEventListener("keydown", this._handleEscapeKey);
  }
  disconnectedCallback() {
  ...
  _shiftTooltipIntoViewport(e) {
    ...
    const d = e.getBoundingClientRect(), h = (r - d.left) / d.width, b = Math.max(0, Math.min(1, h)) * 100;
...
fe([
  z()
], Y.prototype, "_active", 2);
fe([
  n({ type: String, reflect: !0 })
], Y.prototype, "position", 1);
customElements.get("nys-tooltip") || customElements.define("nys-tooltip", Y);
const It = `<svg xmlns="http://www.w3.org/2000/svg" width="91" height="55" viewBox="0 0 91 55" fill="none">
...
const i1 = class i1 extends u {
  ...
  async _handleSlotChange() {
    ...
    if (o && s) {
      ...
      const r = this._normalizePath(
        window.location.pathname + window.location.hash
      );
      t.forEach((i) => {
        if (i.nodeType === Node.ELEMENT_NODE) {
          const c = i.cloneNode(!0), d = i.cloneNode(!0);
          ["script", "iframe", "object", "embed, img"].forEach((m) => {
            c.querySelectorAll(m).forEach((w) => w.remove());
          });
          const b = (m) => {
            const w = Array.from(m.querySelectorAll("a"));
            let ge = {
              li: null,
              length: 0
            };
            w.forEach((Le) => {
              const c1 = Le.getAttribute("href"), be = this._normalizePath(c1);
              be && (be === "/" && r === "/" ? ge = { li: Le.closest("li"), length: 1 } : r?.startsWith(be) && be.length > ge.length && (ge = { li: Le.closest("li"), length: be.length }), w.forEach((v1) => v1.closest("li")?.classList.remove("active")), ge.li?.classList.add("active"));
            });
          };
          b(c), b(d), o.appendChild(c), s.appendChild(d), i.remove();
        }
      });
    }
  }
    ...
    o && (o.classList.toggle("columns", s), o.classList.toggle("small", !s), o.innerHTML = "", t.forEach((i) => {
      if (i.nodeType === Node.ELEMENT_NODE) {
        ...
        ["script", "iframe", "object", "embed", "img"].forEach((h) => {
          c.querySelectorAll(h).forEach((b) => b.remove());
...
customElements.get("nys-globalfooter") || customElements.define("nys-globalfooter", ue);
const Tt = `<svg xmlns="http://www.w3.org/2000/svg" width="91" height="55" viewBox="0 0 91 55" fill="none">
...
l1.styles = p(jt);
let Pe = l1;
customElements.get("nys-unavfooter") || customElements.define("nys-unavfooter", Pe);
export {
  he as NysAccordion,
  J as NysAccordionItem,
  V as NysAlert,
  I as NysAvatar,
  ae as NysBacktotop,
  A1 as NysBadge,
  f as NysButton,
  k as NysCheckbox,
  E as NysCheckboxgroup,
  $e as NysDivider,
  ye as NysErrorMessage,
  L as NysFileinput,
  ue as NysGlobalFooter,
  oe as NysGlobalHeader,
  G as NysIcon,
  W as NysLabel,
  O as NysModal,
  te as NysOption,
  ee as NysPagination,
  ut as NysRadiobutton,
  S as NysRadiogroup,
  M as NysSelect,
  _e as NysSkipnav,
  T as NysStep,
